...
file_mapping = {
    ...
    144: "144nodes_diameter22_cutoff3.33-repetitions50-overlap100.xlsx",
    256: "256nodes_diameter30_cutoff3.33-repetitions50-overlap100.xlsx",
    576: "576nodes_diameter46_cutoff3.33-repetitions50-overlap100.xlsx",
    1024: "1024nodes_diameter62_cutoff3.33-repetitions50-overlap100.xlsx",
    2025: "2025nodes_diameter88_cutoff3.33-repetitions50-overlap100.xlsx"
}

node_sizes = [144, 256, 576, 1024, 2025]
...
for n in node_sizes:
    df = pd.read_excel(f"./../../results_spt_implementation/grid_graphs/first/{file_mapping[n]}")
...
plt.plot([str(x) for x in node_sizes], stats['stretch_SPT_f256'], marker='s', linestyle='--', label=f'SPT', color=cmap(6), linewidth=1.1, markersize=4, zorder=4)
